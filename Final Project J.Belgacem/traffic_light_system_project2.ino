// C++ code
// Arduino 2 code send and receive signals
...
volatile int t10= 2000; // timer for yellow light
volatile int pedTime= 2000; // timer for ped crossing

enum trafLightState { trafRed, trafGreen,  trafYellow1,  trafYellow2};
 ...
 if(Serial.available()>0)
      {
        ...
        if(signal[0] == 'g' || signal[0] == 'r'|| signal[0] == 'y'|| signal[0] == 'Y')//nested this if
          {
